...
// Inline SVG Icons for social media (aapka purana code)
const InstagramIcon = () => (
    ...
    <>
                ...
                <Form noValidate validated={validated} onSubmit={handleSubscribe}>
                  <InputGroup className="footer-subscribe-group-v2">
                    <Form.Control
                      ...
                      disabled={loading}
                    />
                    <Button type="submit" className="footer-btn-v2" disabled={loading}>
      ...
      <Modal show={showPrivacy} onHide={() => setShowPrivacy(false)} centered size="lg" scrollable>
        ...
        <Modal.Body>
          ...
          <h5>7. Contact Us</h5>
          <p>If you have any questions regarding this privacy policy, you may contact us at: <a href="mailto:contact@thelucknowithread.co.in">contact@thelucknowithread.co.in</a>.</p>
        </Modal.Body>
      </Modal>
      ...
      <Modal show={showTerms} onHide={() => setShowTerms(false)} centered size="lg" scrollable>
        ...
        <Modal.Body>
          ...
          <h5>7. Contact Us</h5>
          <p>If you have any questions about these Terms, please contact us at: <a href="mailto:contact@thelucknowithread.co.in">contact@thelucknowithread.co.in</a>.</p>
        </Modal.Body>
      </Modal>
    </>
  );
