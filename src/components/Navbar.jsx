...
import MobileThemeToggle from './MobileThemeToggle.jsx';
...
const AppNavbar = ({ user, userRole, cartCount, theme, toggleTheme }) => {
    ...
    <>
      ...
      <div className={`navbar-wrapper ${isScrolled ? 'scrolled' : ''}`}>
          ...
          <div className="navbar-icons">
            ...
            {/* == PURANE TOGGLE KO DESKTOP KE LIYE RESTRICT KAREIN == */}
            <div className="d-none d-lg-block">
