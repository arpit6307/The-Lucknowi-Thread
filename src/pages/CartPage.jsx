...
const CartPage = ({ cartItems, removeFromCart, updateCartQuantity, isLoggedIn, isSaleActive, appliedCoupon, setAppliedCoupon, saleDetails }) => {
  ...
  if (isSaleActive && saleDetails && saleDetails.discountTiers) {
    ...
    const applicableTier = saleDetails.discountTiers
      .slice() // Create a copy to avoid mutating the original array
      .sort((a, b) => b.minSpend - a.minSpend) // Sort descending by minSpend
      .find(tier => subtotal >= tier.minSpend);
    
    if (applicableTier) {
      saleDiscountPercent = applicableTier.discountPercent;
    }
  }
